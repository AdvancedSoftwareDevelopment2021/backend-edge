...
@Slf4j
@Component
public class IotdbDeviceCommandUtil {
    /**
     * 设备数据存储前缀
     */
    private static String deviceCommandStoragePrefix;

    /**
     * 设置设备数据存储前缀
     *
     * @param deviceCommandStoragePrefix 设备数据存储前缀
     */
    @Value("${iotdb.storage.device.command.data}")
    public void setDeviceCommandStoragePrefix(String deviceCommandStoragePrefix) {
        IotdbDeviceCommandUtil.deviceCommandStoragePrefix = deviceCommandStoragePrefix;
    }
    ...
    public static String getDeviceCommandTimeSeries(String deviceId) {
        return IotdbDeviceCommandUtil.deviceCommandStoragePrefix + "." + deviceId;
    }
